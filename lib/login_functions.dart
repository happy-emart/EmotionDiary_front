...
String baseUrl = "http://143.248.192.51:4040";
...
class LoginFunctions {
  ...
  Future<String?> onSignup(SignUpData signupData) async {
    ...
    var str =
        await _signup(signupData.email, signupData.password, signupData.name);
    await Future.delayed(const Duration(seconds: 2));
    return str;
  }
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const MainAppSub()),
      );
      return null;
    } else {
